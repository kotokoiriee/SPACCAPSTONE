...
/*
 * --------------------------------------------------------------
 *  NAVBAR THEME PATCH ó matches your login page (#0d1b3e navy)
...
<div class="main">
    ...
    <div class="content">
        ...
        <!-- ‚???ê‚???ê DASHBOARD ‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê -->
        ...
        <!-- ‚???ê‚???ê PROFILE ‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê -->
    ...
    <div style="position:relative;flex-shrink:0">
        ...
        <!-- ‚???ê‚???ê OFFICIALS ‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê -->
    ...
    <?php endif; ?>
        ...
        <!-- ‚???ê‚???ê ZONES ‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê -->
        ...
        <!-- ‚???ê‚???ê HOUSEHOLDS ‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê -->
        ...
        <!-- ‚???ê‚???ê RESIDENTS ‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê -->
        ...
        <!-- ‚???ê‚???ê AYUDA ‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê -->
...
<div id="section-ayuda" class="section">
    ...
    <div class="card">
        ...
        <!-- ‚???ê‚???ê QR ‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê -->
        ...
        <!-- ‚???ê‚???ê ALERTS ‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê‚???ê -->
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <div style="display:flex;align-items:center;gap:12px">
                            ...
                            <div id="add-official-photo-preview" style="width:44px;height:44px;border-radius:50%;background:var(--navy-light);overflow:hidden;display:flex;align-items:center;justify-content:center;font-size:20px;color:var(--navy-mid);flex-shrink:0">ü???§</div>
    ...
    <div class="modal modal-wide">
        ...
        <div class="modal-body" style="min-height:440px">
            ...
            <div id="fdrill-families" style="display:none">
                ...
                <button onclick="showFdrillZones()" class="btn btn-ghost btn-sm" style="margin-bottom:12px">‚???ê Back</button>
            ...
            <div id="fdrill-members" style="display:none">
                ...
                <button onclick="showFdrillFamilies()" class="btn btn-ghost btn-sm" style="margin-bottom:12px">‚???ê Back</button>
            ...
            <div id="fdrill-add-family" style="display:none">
                ...
                <button onclick="showFdrillZones()" class="btn btn-ghost btn-sm" style="margin-bottom:12px">‚???ê Cancel</button>
