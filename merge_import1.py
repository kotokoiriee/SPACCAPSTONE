...
# 1. Add PHP functions and logic before the closing ?> of the PHP block at top
php_logic = """
...
# Insert PHP logic before the closing ?> of the PHP block
closing_php = "?>\n<!DOCTYPE html>"
content = content.replace(closing_php, php_logic + closing_php, 1)
print("PHP logic inserted:", "ir_normalize_date" in content)

# 2. Update sidebar link
content = content.replace(
    "onclick=\"showLoadingAndGo('import_residents.php', this)\"",
    "onclick=\"showSection('import_residents', this)\""
)
print("sidebar link updated:", "showSection('import_residents'" in content)

# 3. Add to sectionTitles
content = content.replace(
    "statistics: 'Statistics', manage_areas: 'Manage Areas',",
    "statistics: 'Statistics', manage_areas: 'Manage Areas', import_residents: 'Import Residents',"
)
print("sectionTitles updated:", "import_residents: 'Import Residents'" in content)
